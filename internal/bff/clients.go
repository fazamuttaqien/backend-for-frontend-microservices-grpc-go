...
func (c *UserClient) Get(ctx context.Context, id, token string) (*userv1.User, error) {
	ctx, cancel := context.WithTimeout(ctx, c.timeout)
	defer cancel()
	res, err := c.client.GetUser(withBearer(ctx, token), &userv1.GetUserRequest{Id: id})
	if err != nil {
		return nil, err
	}
	return res.GetUser(), nil
...
func (c *ProductClient) Get(ctx context.Context, id string) (*productv1.Product, error) {
	ctx, cancel := context.WithTimeout(ctx, c.timeout)
	defer cancel()
	res, err := c.client.GetProduct(ctx, &productv1.GetProductRequest{Id: id})
	if err != nil {
		return nil, err
	}
...
func (c *OrderClient) Get(ctx context.Context, id string) (*orderv1.Order, error) {
	ctx, cancel := context.WithTimeout(ctx, c.timeout)
	defer cancel()
	res, err := c.client.GetOrder(ctx, &orderv1.GetOrderRequest{Id: id})
	if err != nil {
		return nil, err
	}
	return res.GetOrder(), nil
