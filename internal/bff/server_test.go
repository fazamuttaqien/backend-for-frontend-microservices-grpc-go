...
func TestCreateOrderValidation(t *testing.T) {
	if err := validateCreateOrder(CreateOrderRequest{}); err == nil {
		t.Fatal("expected validation error")
	}
	if err := validateCreateOrder(CreateOrderRequest{Items: []CreateOrderItem{{ProductID: "p1", Quantity: 0}}}); err == nil {
